        ...
        <div class="flex align-items-center">
            <div class="flex-25 bmg-mobile-first half-width-padding position-relative">
                <div class="product-item__thumb">
                    ...
                    <?php echo do_shortcode('[recycling_badge]'); ?>

                </div>
                <!-- <div class="flex align-items-center justify-content-between">
                            <div class="bmg-energy-wrap">
                                <div id="featurelogos-<?php //echo $ean; 
                                                        ?>"></div>
                                <div id="manuals-<?php //echo $ean; 
                                                    ?>" class="bmg-energy"></div>
                            </div>
                        </div> -->
            </div>
            <div class="bmg-mobile-second-wrap">
                <div class="flex-50 bmg-mobile-second">
                    <div class="flex align-items-start justify-content-between mb-2">
                        <div class="flex-100">
                            ...
                            <!-- <div id="bmg-essentialinfo-<?php //echo $ean; 
                                                            ?>"></div> -->
                            ...
                            <!-- <div class="bmg-meta flex justify-content-flex-star">
                                        ...
                                        <div class="bmg-meta__item flex">
                                            ...
                                            <div class="bmg-meta__value"> <?php //echo $sku; 
                                                                            ?></div>
                                        </div>
                                        <?php //} 
                                        ?>
                ...
                <div class="flex-25 mb-0 bmg-mobile-third">
                    ...
                    if ($product->is_on_sale()) { ?>
                        <div class="woocommerce_sale custom_list_sale">
                            <?php
                            echo do_shortcode('[sale_label]'); ?>
                        </div>
                    <?php   } ?>
                    ...
                    <div id="bmg-cart-btn" class="flex align-items-center ">
                        <div class="product-item__actions">
                            <div class="product-item__action product-item__action--add-to-cart">
                                ...
                                <a class="button add_to_cart_button product_type_simple" href="<?php echo esc_url($link); ?>" title="<?php the_title(); ?>">View Product</a>
                                    <?php
                                    // echo apply_filters(
                        ...
                        <!-- <div class="bmg-more-details">
                                        <a href="<?php //esc_url(get_permalink($product->get_id())) 
                        ...
                        <?php if ($warranty) { ?>
                            <div class="bmg-more-details">
                                ...
                                <?php
                                if ($packaging) {
                                    echo '<a href="/glossary/#packaging" class="bmg-prod-packaging" target="_blank"><span>' . ($custom_packaging ? $custom_packaging : $packaging) . '</span></a>';
                                }
                                echo '<a href="/glossary/#warranty" class="bmg-prod-warranty" target="_blank"><span>' . ($custom_warranty ? $custom_warranty : $warranty) . '</span></a>';


                                if ($condition || $other_conditions) {
                                    echo '<a href="/glossary/#condition" class="bmg-prod-condition" target="_blank">';

                                    if ($condition) {

                                        if (in_array('front', $condition)) {
                                            echo '<span><strong>Front: </strong>' . ($front_custom ? $front_custom : $front) . '</span>';
                                        }
                                        if (in_array('top', $condition)) {
                                            echo '<span><strong>Top: </strong>' . ($top_custom ? $top_custom : $top) . '</span>';
                                        }
                                        if (in_array('left', $condition)) {
                                            echo '<span><strong>Left: </strong>' . ($left_custom ? $left_custom : $left) . '</span>';
                                        }
                                        if (in_array('right', $condition)) {
                                            echo '<span><strong>Right: </strong>' . ($right_custom ? $right_custom : $right) . '</span>';
                                        }
                                    }

                                    if ($other_conditions) {
                                        echo '<span><strong>Other: </strong>';
                                    ...
                                    if ($other_conditions && in_array('Custom Field', $other_conditions)) {
                                        echo '<span><strong>Other: </strong>' . $other_condition_custom . '</span>';
                                    }
                                    echo '</a>';
                                }
